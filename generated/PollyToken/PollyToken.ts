...
export class PollyToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class PollyToken extends ethereum.SmartContract {
  static bind(address: Address): PollyToken {
    return new PollyToken("PollyToken", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): PollyToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new PollyToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<PollyToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new PollyToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
